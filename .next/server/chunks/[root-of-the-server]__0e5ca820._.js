module.exports = [
"[project]/.next-internal/server/app/api/admin/matricula/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/matricula/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (!gradoId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json([], {
            status: 200
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(matriculas.map((m)=>({
                id: m.estudiante.id,
...
async function POST(req) {
    try {
        ...
        if (typeof gradoId !== 'number' || isNaN(gradoId) || typeof estudianteId !== 'number' || isNaN(estudianteId)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'gradoId y estudianteId deben ser números válidos.'
            }, {
                status: 400
            });
        }
        ...
        if (user.role !== 'STUDENT') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Solo se pueden matricular usuarios con rol estudiante.'
            }, {
                status: 400
            });
        }
        ...
        if (existe) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'El estudiante ya está matriculado en este grado.'
            }, {
                status: 409
            });
        }
        ...
        if (user.maxGradoAlcanzadoId && grado.id < user.maxGradoAlcanzadoId) {
            const maxGrado = await prisma.grado.findUnique({
                where: {
                    id: user.maxGradoAlcanzadoId
                }
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Error inesperado al matricular estudiante.'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0e5ca820._.js.map