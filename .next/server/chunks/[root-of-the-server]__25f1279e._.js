module.exports = [
"[project]/.next-internal/server/app/api/docente/tareas/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/docente/tareas/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const asignaciones = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materiaGradoDocente.findMany({
            where: {
                docenteId: docenteId
            },
            select: {
        ...
        if (materiaId) {
            if (!materiaIds.includes(materiaId)) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: 'No autorizado para acceder a esa materia'
                }, {
                    status: 403
                });
            }
        ...
        const tareas = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].tarea.findMany({
            where,
            include: {
                materia: true,
                entregas: {
...
async function POST(req) {
    try {
        ...
        if (!materiaId || !titulo) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Faltan parámetros: materiaId, titulo'
            }, {
                status: 400
            });
        }
        ...
        if (!asignacion) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No autorizado: no tienes asignada esta materia'
            }, {
                status: 403
            });
        }
        ...
        // Crear tarea
        const tarea = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].tarea.create({
            data: {
                materiaId,
                titulo,
...
async function PUT(req) {
    try {
        ...
        if (!tareaId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Falta parámetro: tareaId'
            }, {
                status: 400
            });
        }
        // Verificar permisos: que el docente tenga asignada la materia de esta tarea
        const tarea = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].tarea.findUnique({
            where: {
                id: tareaId
            },
            include: {
        ...
        // Actualizar
        const tareaActual = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].tarea.update({
            where: {
                id: tareaId
            },
            data: {
...
async function DELETE(req) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].entrega.deleteMany({
            where: {
                tareaId
            }
        });
        // Eliminar tarea
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].tarea.delete({
            where: {
                id: tareaId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25f1279e._.js.map