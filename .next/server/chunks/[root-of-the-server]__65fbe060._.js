module.exports = [
"[project]/.next-internal/server/app/api/admin/anuncios/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/anuncios/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const anuncios = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].anuncio.findMany({
            where: whereClause,
            include: {
                autor: {
                    select: {
...
async function POST(req) {
    try {
        ...
        if (!mensaje || !tipo) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Faltan parámetros: mensaje, tipo'
            }, {
                status: 400
            });
        }
        ...
        const anuncio = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].anuncio.create({
            data: {
                mensaje,
                tipo,
...
async function PUT(req) {
    try {
        ...
        if (!anuncioId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Falta parámetro: anuncioId'
            }, {
                status: 400
            });
        }
        const anuncio = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].anuncio.findUnique({
            where: {
                id: anuncioId
            }
        });
        ...
        const anuncioActualizado = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].anuncio.update({
            where: {
                id: anuncioId
            },
            data: {
...
async function DELETE(req) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].anuncio.delete({
            where: {
                id: anuncioId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__65fbe060._.js.map