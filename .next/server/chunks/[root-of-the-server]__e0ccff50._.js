module.exports = [
"[project]/.next-internal/server/app/api/estudiante/tareas/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/estudiante/tareas/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const gradosEstudiante = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].gradoEstudiante.findMany({
            where: {
                estudianteId
            },
            include: {
        ...
        const materiasGrado = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materiaGrado.findMany({
            where: {
                gradoId: {
                    in: gradoIds
                }
...
async function POST(req) {
    try {
        ...
        const gradoIds = gradosEstudiante.map((ge)=>ge.grado.id);
        const materiaEnGrado = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materiaGrado.findFirst({
            where: {
        ...
        const entregaExistente = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].entrega.findFirst({
            where: {
                tareaId,
                estudianteId
            }
        ...
        if (entregaExistente) {
            ...
            entrega = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].entrega.update({
                where: {
            ...
            // Crear nueva entrega
            entrega = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].entrega.create({
                data: {
                    tareaId,
                    estudianteId,
                    texto: texto || null,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e0ccff50._.js.map