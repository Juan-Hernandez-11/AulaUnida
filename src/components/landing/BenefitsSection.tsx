        ...
        },
        {
          ...
          icon: (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <line x1="9" y1="9" x2="9" y2="15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <line x1="15" y1="9" x2="15" y2="15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          )
        },
        {
      ...
      <div className={styles.container}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionSubtitle}>
            Descubre cómo AulaUnida transforma la experiencia educativa para cada miembro de tu institución
          </p>
        </div>

        <div className={styles.tabsContainer}>
          <div className={styles.tabsNav}>
            {Object.entries(benefitsTabs).map(([key, tab]) => (
              <button
                key={key}
          ...
          <div className={styles.tabContent}>
            <div className={styles.benefitsGrid}>
              {benefitsTabs[activeTab as keyof typeof benefitsTabs].benefits.map((benefit, index) => (
                <div
                  key={index}
        ...
        <div className={styles.featuresShowcase}>
          <div className={styles.showcaseGrid}>
            <div className={styles.showcaseItem}>
              ...
              <h4>Velocidad Lightning</h4>
              <p>Acceso instantáneo a toda tu información académica</p>
            </div>
            ...
            <div className={styles.showcaseItem}>
              ...
              <p>Funciona perfectamente en computador, tablet y móvil</p>
            </div>
            ...
            <div className={styles.showcaseItem}>
              ...
              <p>99.9% de disponibilidad, accede cuando lo necesites</p>
            </div>
          </div>
        </div>
      </div>
