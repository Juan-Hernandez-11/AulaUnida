module.exports = [
"[project]/.next-internal/server/app/api/admin/materias/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/materias/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$requireAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
async function GET(request) {
    ...
    let materias;
    if (gradoId) {
        materias = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materia.findMany({
            where: {
                materiaGrados: {
                    some: {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(materias);
}
async function POST(request) {
    ...
    if (typeof nombre !== 'string' || !nombre.trim() || typeof area !== 'string' || !area.trim() || typeof codigo !== 'string' || !codigo.trim() || !Array.isArray(gradoIds) || gradoIds.length === 0 || gradoIds.some((id)=>typeof id !== 'number' || isNaN(id))) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const grados = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].grado.findMany({
        where: {
            id: {
                in: gradoIds
            }
    ...
    if (grados.length !== gradoIds.length) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Uno o más grados no existen'
        }, {
            status: 400
        });
    }
    // Validar unicidad de código
    const existe = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materia.findFirst({
        where: {
            codigo: codigo.trim()
        }
    });
    ...
    try {
        const materia = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materia.create({
            data: {
                nombre: nombre.trim(),
                area: area.trim(),
                codigo: codigo.trim(),
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(materia);
    } catch (e) {
...
async function PUT(request) {
    ...
    if (typeof id !== 'number' || isNaN(id) || typeof nombre !== 'string' || !nombre.trim() || typeof area !== 'string' || !area.trim() || typeof codigo !== 'string' || !codigo.trim() || !Array.isArray(gradoIds) || gradoIds.length === 0 || gradoIds.some((id)=>typeof id !== 'number' || isNaN(id))) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Faltan campos obligatorios o tipos incorrectos'
        }, {
            status: 400
    ...
    try {
        // Actualiza materia
        const materia = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materia.update({
            where: {
                id
            },
            data: {
        ...
        // Sincroniza grados
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materiaGrado.deleteMany({
            where: {
                materiaId: id
            }
        });
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materiaGrado.createMany({
            data: gradoIds.map((gradoId)=>({
                    materiaId: id,
                    gradoId
                })),
            skipDuplicates: true
        });
        const materiaActualizada = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materia.findUnique({
            where: {
                id
            },
            include: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(materiaActualizada);
    } catch (e) {
        if (e.code && e.code.startsWith('P')) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Error de base de datos: ' + e.message
...
async function DELETE(request) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].materia.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__46c924ac._.js.map