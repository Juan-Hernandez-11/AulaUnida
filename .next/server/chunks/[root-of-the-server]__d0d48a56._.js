module.exports = [
"[project]/.next-internal/server/app/api/docente/asistencia/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/docente/asistencia/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (!materiaId || !gradoId || !fecha) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Faltan parámetros: materiaId, gradoId, fecha'
            }, {
                status: 400
            });
        }
        ...
        if (!materiaGrado) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No existe esa asignación materia/grado'
            }, {
                status: 404
            });
        }
        ...
        if (!asignacion) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No autorizado para registrar asistencia en esta clase'
            }, {
                status: 403
            });
        }
...
async function POST(req) {
    try {
        ...
        if (!asignacion) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No autorizado para registrar asistencia'
            }, {
                status: 403
            });
        }
        ...
        for (const registro of registros){
            ...
            const estudianteEnGrado = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].gradoEstudiante.findFirst({
                where: {
                    estudianteId,
                    gradoId
                }
            ...
            const existente = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].asistencia.findFirst({
                where: {
                    estudianteId,
                    materiaId,
                    fecha: {
            ...
            if (existente) {
                // Actualizar
                asistencia = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].asistencia.update({
                    where: {
                        id: existente.id
                    },
                    data: {
                ...
                // Crear nuevo
                asistencia = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].asistencia.create({
                    data: {
                        estudianteId,
                        materiaId,
                        fecha: fechaDate,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d0d48a56._.js.map