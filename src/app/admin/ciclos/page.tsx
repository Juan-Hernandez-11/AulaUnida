      ...
      <div className={styles.dashboardContainer}>
        ...
        <main className={styles.mainContent}>
          ...
          <div className={styles.activityCard}>
            <h2 className={styles.activityTitle}>Crear/Editar Ciclo</h2>
            <form style={{ display: 'flex', gap: 16, marginBottom: 24 }}>
              <input className="border p-2 rounded flex-1" placeholder="Nombre del ciclo" disabled />
              <input className="border p-2 rounded flex-1" placeholder="Fecha inicio" disabled />
              <input className="border p-2 rounded flex-1" placeholder="Fecha fin" disabled />
              <button className="bg-blue-500 text-white rounded p-2" disabled>Guardar</button>
            </form>
          </div>
          <div className={styles.activityCard}>
