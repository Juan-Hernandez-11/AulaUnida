            ...
            user.getIdToken().then({
                "NotasPage.useEffect": (token)=>{
                    fetch('/api/estudiante/notas', {
                        ...
                        "NotasPage.useEffect": (err)=>console.error('Error fetching notas', err)
                    }["NotasPage.useEffect"]);
                }
            }["NotasPage.useEffect"]);
        }
...
_s(NotasPage, "FQvH9lQbdkvs2k/mqy4nRrAR3HE=", false, function() {
    return [
...
//# sourceMappingURL=_f472910c._.js.map