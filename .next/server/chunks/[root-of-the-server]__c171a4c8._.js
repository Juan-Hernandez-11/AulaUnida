module.exports = [
"[project]/.next-internal/server/app/api/docente/notas/detalles/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/docente/notas/detalles/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (valor < 0 || valor > 5) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Valor debe estar entre 0 y 5'
            }, {
                status: 400
            });
        }
        if (peso < 0 || peso > 100) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Peso debe estar entre 0 y 100'
            }, {
                status: 400
            });
        }
        // Crear nota detalle
        const notaDetalle = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notaDetalle.create({
            data: {
...
async function GET(req) {
    try {
        ...
        const notasDetalles = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notaDetalle.findMany({
            where: {
                estudianteId,
                materiaId,
                periodoId
        ...
        const promedioPonderado = totalPeso > 0 ? notasDetalles.reduce((sum, n)=>sum + n.valor * n.peso / 100, 0) : 0;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            notas: notasDetalles,
...
async function DELETE(req) {
    try {
        ...
        const notaEliminada = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notaDetalle.delete({
            where: {
                id: notaId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c171a4c8._.js.map