module.exports = [
"[project]/.next-internal/server/app/api/estudiante/init-data/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/estudiante/init-data/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!user || user.role !== 'STUDENT') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No autorizado (solo estudiante)'
            }, {
                status: 403
            });
        }
        // Verificar si ya está matriculado
        const yaMatriculado = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].gradoEstudiante.findFirst({
            where: {
        ...
        const primerGrado = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].grado.findFirst({
            orderBy: {
                nombre: 'asc'
            }
        });
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].gradoEstudiante.create({
            data: {
                estudianteId: user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__49913dfc._.js.map